...
chsmack -a 'User' /opt/dbspace/.wrt.db
chsmack -a 'User' /opt/dbspace/.wrt.db-journal
chsmack -a 'User' /opt/usr/dbspace/.wrt_custom_handler.db
chsmack -a 'User' /opt/usr/dbspace/.wrt_custom_handler.db-journal
chsmack -a 'User' /opt/usr/dbspace/.wrt_i18n.db
chsmack -a 'User' /opt/usr/dbspace/.wrt_i18n.db-journal
